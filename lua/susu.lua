...
M.setup = function(config)
  ...
  vim.keymap.set("n", config.binds.super_in, function() put_char("super") end, { noremap = true, silent = true })
  vim.keymap.set("n", config.binds.sub_in, function() put_char("sub") end, { noremap = true, silent = true })
